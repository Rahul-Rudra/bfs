...
class ManufacturingComponent extends Component {
  ...
  getManufacturingVideos = () => {
    ...
    fetch(
      globalVar.base_url +
      '/umbraco/api/Content/GetChildren/' +
      RootId,
      {
        method: 'get'
      }
    ...
    return (
      <div className="container midcontent">
        <div className="col-12 p-lg-0">
            ...
            {this.state.backimage ? (
              <div className="banner">
                <img
                  ...
                  border="0"
                  alt="Resource Center - Green Works "
                />
              </div>
            ) : null}
          ...
          {this.state.manufacturingitems.length > 0 ? (
            <div className="content_full_all">
              <div className="row">
                <div className="col-sm-12">
                  ...
                  <div className="MediaListWrap">
                      ...
                      <div className="row">
                        {this.state.manufacturingitems
                          ...
                          .map((item, index) => (
                            ...
                            >
                              <div className="py-3 mt-2 text-center text-blue">
                                {item?.TypeName}
                              </div>
                              {item?.TypeImage ? (
                                <div>
                    ...
                    {videolistitems.length > 0 ? (
                      <div className="py-4 mt-5" id="video">
                            ...
                            {videolistitems
                              ...
                              .map((item, index) => (
                                <li
                                  ...
                                  data-target="#manufacturingVideoModal"
                                >
